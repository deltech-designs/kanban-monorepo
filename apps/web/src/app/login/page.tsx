  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-gradient-to-b from-[#3B3AEC] to-[#4A3CF0] flex-col justify-between p-12 text-white relative overflow-hidden">
        ...
        <div className="max-w-md mt-20 mb-auto">
          ...
          <p className="text-lg text-white/80 leading-relaxed max-w-[400px]">
            Move away from stagnant project management.
            <br />
            Experience a fluid, editorial approach to your daily productivity.
          </p>
        </div>

        {/* User's Data Cards styled like Trust Badge */}
        ...
        {/* <div className="flex gap-4 w-full bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
          <div className="flex-1">
            <p className="text-[10px] font-bold tracking-wider text-white/60 mb-4">
              ACTIVE TASKS
            </p>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
        <div className="flex flex-col justify-center max-w-[440px] w-full mx-auto">
          ...
          <p className="text-center text-[14px] text-gray-600 mt-8">
            ...
            <Link href="/signup" className="text-[#4A3CF0] font-semibold hover:underline">
              Create Account
            </Link>
          </p>
        </div>
