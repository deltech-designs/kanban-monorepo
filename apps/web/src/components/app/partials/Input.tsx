...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, hint, id, className = '', type, icon, ...props }, ref) => {
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={id}
            type={inputType}
            className={`w-full p-2.5 ${icon ? 'pl-10 ' : ''}${isPassword ? 'pr-10 ' : ''}border border-gray-300 rounded-md text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors ${className}`}
            {...props}
          />
          {isPassword && (
            <button
