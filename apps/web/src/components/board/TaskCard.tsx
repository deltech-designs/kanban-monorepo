  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-auto pt-1">
        <div
          className={`flex items-center gap-1.5 text-xs font-bold border border-gray-100 rounded-md px-2 py-1 ${task.dateStr === 'Today' ? 'text-orange-500 bg-orange-50/50' : 'text-gray-500 bg-gray-50/50'}`}
        >
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path
              strokeLinecap="round"
        ...
        <div
          className={`w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-bold ring-2 ring-white ${task.assignee.avatarColor}`}
        >
